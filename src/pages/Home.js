  ...
  return (
    <div className="text-left">
      ...
      <div className="bg-header-blue py-10">
        <div className="w-5/12 m-auto">
          <h1 className="font-bold py-5 text-3xl">
            Fine-grained Apparel category Classification & Try-On Recommender
            System{" "}
          </h1>
          <span>
            The model which can superimpose the clothing images on the customers
            so they can see for themselves how the fit will look on their own
            bodies.{" "}
          </span>
        </div>
      </div>
      ...
      <div className="w-5/12 m-auto text-center py-10">
        ...
        <span>
          The model will superimpose the clothing you like from the clothing
          menu, and display on your image you upload. You can upload the image
          by signing up. If you have signed up already, you’re all set!
        </span>
      </div>
    </div>
  );
