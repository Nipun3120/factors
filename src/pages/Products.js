...
const products = [
    ...
    {
        id: 4,
        imageId:"https://i.pinimg.com/736x/bf/e1/9a/bfe19a78858b503980f6d5b405b7f755.jpg",
    },
    {
        id: 5,
        imageId: "https://johnlewis.scene7.com/is/image/JohnLewis/005619867?$rsp-pdp-port-640$",
...
export const Products = () => {
    ...
    return(
        ...
        <div>
                    ...
                    products.map(product => {
                        return(
                            <div key={product.id} className="flex flex-col">
                                <img src={product.imageId} alt="women top" className="h-80 w-60"/>
                                <button onClick={handleOpen} className="bg-gray-300 mt-3 py-1">Try it on</button>
                            </div>
                        )
                    })
                }
            ...
            >
                <Box sx={style}>
                    {loading && <LinearProgress color="success" className='sticky mb-4'/> }
